    ...
    return (
        ...
        <div className='to-do-component'>
            ...
            <form className={taskNameError ? 'form-error' : ''} onSubmit={event => createTask(event)}>
                ...
                <h1>{contents.toDoComponent.form.title[config.language]}</h1>

                <div className='form-controller'>
                    <label htmlFor="">{
                        contents.toDoComponent.form.inputName.label[config.language]}
                    </label>
                    <input
                        type="text"
                        value={taskName}
                        ...
                        <small>
                            {contents.toDoComponent.form.inputName.error[config.language]}
                        </small>
                </div>

                <button disabled={taskNameError}>
                    {contents.toDoComponent.form.buttoName[config.language]}
                </button>
