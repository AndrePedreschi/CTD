...
public class Funcionario extends Vendedores{
    ...
    private ArrayList<Vendedores> afiliados = new ArrayList<>();
    ...
    public void addAfiliado(Vendedores afiliado){
    ...
    //por ano de antiguidade obtem 5 pontos, por cada afiliado obtém 10 pontos
